...
public class AsyncZuulServlet extends HttpServlet {
	...
	private DynamicIntProperty asyncTimeout = DynamicPropertyFactory.getInstance().getIntProperty(ZuulConstants.ZUUL_SERVLET_ASYNC_TIMEOUT, 20000);
	private DynamicIntProperty coreSize = DynamicPropertyFactory.getInstance().getIntProperty(ZuulConstants.ZUUL_THREADPOOL_CODE_SIZE, 200);
	private DynamicIntProperty maximumSize = DynamicPropertyFactory.getInstance().getIntProperty(ZuulConstants.ZUUL_THREADPOOL_MAX_SIZE, 2000);
	private DynamicLongProperty aliveTime = DynamicPropertyFactory.getInstance().getLongProperty(ZuulConstants.ZUUL_THREADPOOL_ALIVE_TIME, 1000 * 60 * 5);
