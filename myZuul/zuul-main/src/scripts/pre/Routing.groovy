...
class Routing extends ZuulFilter {
    ...
    boolean shouldFilter() {
        DynamicStringProperty debugFilterShutoff = DynamicPropertyFactory.getInstance().getStringProperty(ZuulConstants.ZUUL_DEBUGFILTERS_DISABLED, "moren");
        System.out.println(ZuulConstants.ZUUL_DEBUGFILTERS_DISABLED+debugFilterShutoff.get());
        return true
    }
