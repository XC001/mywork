...
class DebugFilter extends ZuulFilter {
    ...
    boolean shouldFilter() {
        DynamicBooleanProperty adminEnabled = DynamicPropertyFactory.getInstance().getBooleanProperty(ZuulConstants.ZUUL_FILTER_ADMIN_ENABLED, false);
        println("==============="+adminEnabled.get())
